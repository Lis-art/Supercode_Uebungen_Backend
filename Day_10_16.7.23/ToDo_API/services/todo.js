...
export const deleteToDo = async (id) => {
  // Alle Todos werden aus der lokalen JSON geladen
  let allToDos = JSON.parse(fs.readFileSync(todoFileUrl, "utf8"));
  // Danach wird das zulöschende ToDo anhand der übermittelten ID gefiltert. Was bleibt ist eine gefilterte Kopie der Json ohne der gesuchten ID. Damit wird gleichzeitig das Array gekürzt
